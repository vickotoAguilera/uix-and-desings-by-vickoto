      ...
      <div className="p-10 space-y-16 max-w-7xl mx-auto">
        <header className="mb-20">
          <h1 className="text-5xl font-black mb-4 bg-gradient-to-r from-[#0fa] to-blue-500 bg-clip-text text-transparent tracking-tighter">
            TRANSITIONS & EFFECTS CATALOG
          </h1>
          <p className="text-zinc-500 text-xl max-w-3xl">
            Colección de efectos de transición optimizada para evitar
            sobrecargas en el sistema mediante carga bajo demanda.
          </p>
        </header>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
          {Object.keys(TransitionVariants).map((name, index) => {
            const Component =
              TransitionVariants[name as keyof typeof TransitionVariants];
            return (
